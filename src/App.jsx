...
export default function App() {
  ...
  }), [prefs.quality, prefs.playerName]);
  ...
  let body;
  if (view === 'arena') {
    body = <Arena key={`${prefs.modeId}-${prefs.heroId}-${round}`} modeId={prefs.modeId} heroId={prefs.heroId} options={options} debug={debug} onExit={toMenu} onAgain={again} />;
  } else if (view === 'modes') {
    ...
    body = <Rating onBack={toMenu} />;
  } else {
    body = <MainMenu prefs={prefs} onPlay={play} go={setView} />;
  }
